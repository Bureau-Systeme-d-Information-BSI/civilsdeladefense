...
class JobOffer < ApplicationRecord
  ...
  def self.ransackable_attributes(auth_object = nil)
    [
      "accepted_job_applications_count",
      "affected_job_applications_count",
      "after_meeting_rejected_job_applications_count",
      ...
      "category_id",
      "city",
      "contract_drafting_job_applications_count",
      "contract_duration_id",
      "contract_feedback_waiting_job_applications_count",
      "contract_received_job_applications_count",
      "contract_start_on",
      "contract_type_id",
      "country_code",
      "county",
      ...
      "id_value",
      "identifier",
      "initial_job_applications_count",
      "is_remote_possible",
      ...
      "mobilia_date",
      "mobilia_value",
      "most_advanced_job_applications_state",
      "notifications_count",
      "option_photo",
      "organization_description",
      "organization_id",
      "owner_id",
      "phone_meeting_job_applications_count",
      "phone_meeting_rejected_job_applications_count",
      "postcode",
      "professional_category_id",
      "published_at",
      "recruitment_process",
      "region",
      "rejected_job_applications_count",
      "required_profile",
      "sector_id",
      "sequential_id",
      "slug",
      ...
      "suspended_at",
      "title",
      "to_be_met_job_applications_count",
      "updated_at"
    ]
  end
