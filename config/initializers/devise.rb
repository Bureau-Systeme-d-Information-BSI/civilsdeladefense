...
Devise.setup do |config|
  ...
  # config.secret_key = '9b01d624e5d700da5776aad88be0718312c0523502def991078da092ddf113651810aa8982e8505f34db505708fbe2b3339755123b6eb0b149ea3bd5d998423c'
  ...
  # config.pepper = '7256fb8b001b561a87b51e105f0ab7f10e9107a52db4bac2ef41ba0e87791ba4b24b95280fc2672c2c045afe75f622d6803e9d399e264746cdc83769613622a2'
  ...
  config.omniauth :openid_connect, {
    ...
    response_type: :code,
    uid_field: "sub",
    issuer: "https://#{Rails.application.credentials.france_connect&.host}/api/v2",
    ...
    client_options: {
      port: 443,
      scheme: "https",
      host: Rails.application.credentials.france_connect&.host,
      ...
      jwks_uri: "https://#{Rails.application.credentials.france_connect&.host}/api/v2/jwks",
