...
JobApplicationFileType.create! name: name,
                               kind: :applicant_provided,
                               from_state: :accepted,
                               by_default: true
...
JobApplicationFileType.create! name: "Certificat Médical",
                               description: description,
                               kind: :applicant_provided,
                               from_state: :accepted,
                               by_default: true
...
JobApplicationFileType.create! name: "Relevé d'identité bancaire",
                               description: description,
                               kind: :applicant_provided,
                               from_state: :accepted,
                               by_default: true
