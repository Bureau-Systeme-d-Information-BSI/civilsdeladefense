  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested job_offer" do
        job_offer = JobOffer.create! valid_attributes
        put :update, params: {id: job_offer.to_param, job_offer: new_attributes}, session: valid_session
        job_offer.reload
      ...
      it "redirects to the job_offer" do
        job_offer = JobOffer.create! valid_attributes
        put :update, params: {id: job_offer.to_param, job_offer: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        job_offer = JobOffer.create! valid_attributes
        put :update, params: {id: job_offer.to_param, job_offer: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
